...
//                    this.obj.style.top=  this.y+"px";
     ...
     crear_canvas(f_donde, f_size,  f_x, f_y, f_w, f_h, f_style,        f_esp)
     {
       ...
       f_style= setloop_prop({position:'absolute',imageRendering: "pixelated",
        border:'1px solid black',background:'white', pixel_size:f_size  },  f_style);
...
let _bz  = _b + _tag_b.length;
   ...
   if(_a>-1 && _b>-1)
   {
    ...
    return({ texto: f_string.slice(_az,_b),
           original: f_string,
